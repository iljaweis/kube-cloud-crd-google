...
type InstanceLister interface {
	...
	List(selector labels.Selector) (ret []*v1.Instance, err error)
...
// List lists all Instances in the indexer.
func (s *instanceLister) List(selector labels.Selector) (ret []*v1.Instance, err error) {
...
// List lists all Instances in the indexer for a given namespace.
func (s instanceNamespaceLister) List(selector labels.Selector) (ret []*v1.Instance, err error) {
...
// Get retrieves the Instance from the indexer for a given namespace and name.
func (s instanceNamespaceLister) Get(name string) (*v1.Instance, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1.Resource("instance"), name)
	}
