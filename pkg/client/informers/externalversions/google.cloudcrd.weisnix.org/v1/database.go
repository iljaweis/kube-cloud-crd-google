...
import (
	...
	versioned "github.com/iljaweis/kube-cloud-crd-google/pkg/client/clientset/versioned"
	internalinterfaces "github.com/iljaweis/kube-cloud-crd-google/pkg/client/informers/externalversions/internalinterfaces"
	v1 "github.com/iljaweis/kube-cloud-crd-google/pkg/client/listers/google.cloudcrd.weisnix.org/v1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options meta_v1.ListOptions) (runtime.Object, error) {
				...
				return client.GoogleV1().Databases(namespace).List(options)
			},
			WatchFunc: func(options meta_v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.GoogleV1().Databases(namespace).Watch(options)
			},
		},
		&google_cloudcrd_weisnix_org_v1.Database{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *databaseInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&google_cloudcrd_weisnix_org_v1.Database{}, f.defaultInformer)
}
